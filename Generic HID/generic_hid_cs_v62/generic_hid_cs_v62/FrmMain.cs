...
namespace GenericHid
{
		...
		: Form
	{
        ...
        internal TextBox txtByte0;
        internal TextBox txtByte2;
        internal TextBox txtByte1;
		...
		private void InitializeComponent()
		{
            ...
            this.txtByte0 = new System.Windows.Forms.TextBox();
            ...
            this.FraBytesToSend.Controls.Add(this.label3);
            this.FraBytesToSend.Controls.Add(this.label2);
            this.FraBytesToSend.Controls.Add(this.label1);
            this.FraBytesToSend.Controls.Add(this.txtByte2);
            this.FraBytesToSend.Controls.Add(this.txtByte1);
            this.FraBytesToSend.Controls.Add(this.txtByte0);
            ...
            // txtByte2
            // 
            this.txtByte2.Location = new System.Drawing.Point(73, 71);
            this.txtByte2.Name = "txtByte2";
            this.txtByte2.Size = new System.Drawing.Size(72, 20);
            this.txtByte2.TabIndex = 6;
            this.txtByte2.Text = "000000";
            // 
            // txtByte1
            // 
            this.txtByte1.Location = new System.Drawing.Point(73, 45);
            this.txtByte1.Name = "txtByte1";
            this.txtByte1.Size = new System.Drawing.Size(72, 20);
            this.txtByte1.TabIndex = 5;
            this.txtByte1.Text = "000000";
            // 
            // txtByte0
            // 
            this.txtByte0.Location = new System.Drawing.Point(73, 19);
            this.txtByte0.Name = "txtByte0";
            this.txtByte0.Size = new System.Drawing.Size(72, 20);
            this.txtByte0.TabIndex = 4;
            this.txtByte0.Text = "00";
            // 
            // LstResults
            // 
			...
			try
			{
				...
				if (_deviceHandleObtained)
				{
					...
					if ((_myHid.Capabilities.FeatureReportByteLength > 0))
					{
                        ...
                        outFeatureReportBuffer[1] = Convert.ToByte(txtByte0.Text, 16);

                        if (outFeatureReportBuffer.GetUpperBound(0) > 1)
						{
							outFeatureReportBuffer[2] = Convert.ToByte(txtByte1.Text.Substring(0,2), 16);
                        }

                        if (outFeatureReportBuffer.GetUpperBound(0) > 2)
                        {
                            outFeatureReportBuffer[3] = Convert.ToByte(txtByte1.Text.Substring(2, 2), 16);
                        }

                        if (outFeatureReportBuffer.GetUpperBound(0) > 3)
                        {
                            outFeatureReportBuffer[4] = Convert.ToByte(txtByte1.Text.Substring(4, 2), 16);
                        }

                        if (outFeatureReportBuffer.GetUpperBound(0) > 4)
                        {
                            outFeatureReportBuffer[5] = Convert.ToByte(txtByte2.Text.Substring(0, 2), 16);
                        }

                        if (outFeatureReportBuffer.GetUpperBound(0) > 5)
                        {
                            outFeatureReportBuffer[6] = Convert.ToByte(txtByte2.Text.Substring(2, 2), 16);
                        }

                        if (outFeatureReportBuffer.GetUpperBound(0) > 6)
                        {
                            outFeatureReportBuffer[7] = Convert.ToByte(txtByte2.Text.Substring(4, 2), 16);
                        }
			...
			try
			{
				...
				if (!_hidHandle.IsInvalid)
				{
					...
					if (_myHid.Capabilities.OutputReportByteLength > 0)
					{
                        ...
                        outputReportBuffer[1] = Convert.ToByte(txtByte0.Text, 16);

                        if (outputReportBuffer.GetUpperBound(0) > 1)
                        {
                            outputReportBuffer[2] = Convert.ToByte(txtByte1.Text.Substring(0, 2), 16);
                        }

                        if (outputReportBuffer.GetUpperBound(0) > 2)
                        {
                            outputReportBuffer[3] = Convert.ToByte(txtByte1.Text.Substring(2, 2), 16);
                        }

                        if (outputReportBuffer.GetUpperBound(0) > 3)
                        {
                            outputReportBuffer[4] = Convert.ToByte(txtByte1.Text.Substring(4, 2), 16);
                        }

                        if (outputReportBuffer.GetUpperBound(0) > 4)
                        {
                            outputReportBuffer[5] = Convert.ToByte(txtByte2.Text.Substring(0, 2), 16);
                        }

                        if (outputReportBuffer.GetUpperBound(0) > 5)
                        {
                            outputReportBuffer[6] = Convert.ToByte(txtByte2.Text.Substring(2, 2), 16);
                        }

                        if (outputReportBuffer.GetUpperBound(0) > 6)
                        {
                            outputReportBuffer[7] = Convert.ToByte(txtByte2.Text.Substring(4, 2), 16);
                        }
